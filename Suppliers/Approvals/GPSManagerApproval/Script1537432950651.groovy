...
def roleSpecificTasks = WebUI.modifyObjectProperty(availableTasks, 'xpath', 'equals', '//td[@class="h6"]/strong[@class="text-info ng-binding"][count(. | //*[(text() = "Approve Life Supplier Batch")]/parent::td/parent::tr/td[@class="h6 ng-scope"]/button[@class="btn btn-sm ng-scope btn-primary"]', false)
 
WebUI.click(roleSpecificTasks)

WebUI.click(findTestObject('Object Repository/GPS_OR/a_Batch'))

WebUI.click(findTestObject('Object Repository/GPS_OR/a_Approve batch'))